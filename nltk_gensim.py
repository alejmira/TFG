# -*- coding: utf-8 -*-
"""
Created on Tue Feb 22 20:30:08 2022
...
# un número de topics fijo y un número de palabras para mostrar por topic
# Utiliza una función auxiliar print_gensim_topics para mostrar los topcs de forma más estética
# Devuelve un objeto modelo de gensim
...
# Función auxiliar para mostrar los topics de forma más estética
...
def compute_coherence_values_gensim(f, dictionary, matrix, doc_clean, start=2, stop=10, step=1):
    coherence_values = []
...
def plot_coherence(algorithm, doc_clean, mode = "BoW", start = 2, stop = 10, step = 1):
    ...
    if algorithm == "LSA":
        ...
        f = Nmf
    coherence_values = compute_coherence_values_gensim(f, dictionary, matrix,doc_clean, start, stop, step)
    # Show graph
